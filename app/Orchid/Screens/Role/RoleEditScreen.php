...
class RoleEditScreen extends Screen
{
    ...
    {
        return 'Настройка прав доступа для роли';
    }
    ...
    public function layout(): iterable
    {
        return [
            Layout::block([
                ...
                ->title('Роль')
                ->description('Определяет набор привилегий, предоставляющих доступ к различным сервисам.'),

            Layout::block([
                RolePermissionLayout::class,
            ])
                ->title('Права доступа')
                ->description('Права необходимы для выполнения определённых задач и операций.'),
        ];
    }
